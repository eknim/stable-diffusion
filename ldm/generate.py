...
class Generate:
    ...
    def __init__(
        ...
        self.ignore_ctrl_c = (
            ignore_ctrl_c  # note, this logic probably doesn't belong here...
        )
    ...
    def _make_images(self, img_path, mask_path, width, height, fit=False):
        ...
        if mask_path:
            mask_image = self._load_img(
                mask_path, width, height, fit=fit
            )  # this returns an Image
    ...
    def _create_init_mask(self, image):
        ...
        image = image.resize(
            (image.width // downsampling, image.height // downsampling),
